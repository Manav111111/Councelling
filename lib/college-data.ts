...
export const collegesData: CollegeData[] = [
  ...
  },
  {
    ...
    shortName: "DTU",
    alsoKnownAs: ["DCE", "Delhi College of Engineering"],
    ...
    nirfRank: "30",
    fees: {
      annualTuition: 236000,
      total4yr: 950000,
      currency: "INR"
    },
    branches: ["CSE", "IT", "Software Engineering", "ECE", "EE", "Mechanical", "Civil", "Biotechnology", "Engineering Physics"],
    admission: {
      exam: ["JEE Main (through JAC Delhi)"],
      minPcmPercent: 60,
      quota: "No management quota",
      delhiReservationPercent: 85
    },
    placements: {
      year: 2025,
      ...
      topRecruiters: ["Microsoft", "Google", "Adobe", "Amazon", "Apple", "Atlassian", "Samsung R&D", "Deloitte", "Goldman Sachs", "Bain & Company"]
    },
    campus: {
      sizeAcres: 164,
      hostel: true,
      metroAccess: true,
      nearestMetro: "Rithala Metro"
    },
