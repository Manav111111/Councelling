...
updates = {
    "usar": {
        "B.Tech./M. Tech. (DD) (AI-DS)": {"delhiGeneral": [138983, 166801], "outsideGeneral": [49675, 75632], "delhiSC": [310123, 629373], "outsideSC": [233647, 299927]},
        "B.Tech./M. Tech. (DD) (AI-ML)": {"delhiGeneral": [135311, 169427], "outsideGeneral": [51495, 75022], "delhiSC": [343133, 585156], "outsideSC": [234425, 287488]},
        "B.Tech./M. Tech. (DD) (AR)": {"delhiGeneral": [191047, 231134], "outsideGeneral": [70824, 88671], "delhiSC": [573282, 836933], "outsideSC": [308124, 349159]},
        "B.Tech./M. Tech. (DD) (IIOT)": {"delhiGeneral": [195850, 227105], "outsideGeneral": [62206, 93613], "delhiSC": [567061, 882396], "outsideSC": [347636, 352424]}
    },
    "vips": {
        ...
        "B. Tech. (Computer Science & Applied Mathematics)": {"delhiGeneral": [152610, 301597], "outsideGeneral": [119832, 131767], "delhiSC": [992821, 1070255], "outsideSC": [401495, 464205]},
    ...
    "gtbit": {
        ...
        "CSE- AIML": {"delhiGeneral": [197315, 219622], "outsideGeneral": [90455, 99233], "delhiSC": [667335, 752972]},
        "CSE- DS": {"delhiGeneral": [221557, 227700], "outsideGeneral": [100699, 103794], "delhiSC": [990864, 1142567]},
    ...
    "adgitm (niec)": {
        "Artificial Intelligence & Data Science": {"delhiGeneral": [226787, 357099], "outsideGeneral": [126031, 140744], "delhiSC": [984785, 1047436], "outsideSC": [377118, 443716]},
        ...
        "Artificial Intelligence & Machine Learning": {"delhiGeneral": [184127, 340833], "outsideGeneral": [100655, 132826], "delhiSC": [1035267, 1471070], "outsideSC": [429082, 467848]},
        ...
        "B.Tech (CS) II- Shift": {"delhiGeneral": [226158, 318607], "outsideGeneral": [118786, 128144], "delhiSC": [999177, 1204691], "outsideSC": [426539, 426539]},
        ...
        "Computer Science & Technology": {"delhiGeneral": [237587, 298666], "outsideGeneral": [108523, 122907], "outsideSC": [434953, 434953]},
        "Computer Science and Technology (II Shift)": {"delhiGeneral": [272945, 341456], "outsideGeneral": [118731, 134917], "outsideSC": [450428, 450428]},
    ...
    "gtb4cec": {
        ...
        "CSE- AIML": {"delhiGeneral": [221440, 296682], "outsideGeneral": [111097, 118216], "delhiSC": [779610, 1428686], "outsideSC": [375799, 375799]},
    ...
    "hmritm": {
        ...
        "CSE - AI": {"delhiGeneral": [380643, 506284], "outsideGeneral": [149020, 173643], "outsideSC": [588812, 588812]},
        "CSE (Cyber Security)": {"delhiGeneral": [369402, 495493], "outsideGeneral": [138689, 154889]},
        "CSE- AIML": {"delhiGeneral": [353609, 468040], "outsideGeneral": [146994, 158856], "delhiSC": [1179712, 1179712], "outsideSC": [553851, 553851]},
        "CSE- DS": {"delhiGeneral": [364060, 521947], "outsideGeneral": [161675, 169198], "outsideSC": [593256, 593256]},
    ...
    "dtc": {
        ...
        "CSE- AIML": {"delhiGeneral": [261783, 559392], "outsideGeneral": [110589, 167986], "delhiSC": [885484, 885484], "outsideSC": [532186, 535047]},
        "CSE- DS": {"delhiGeneral": [320815, 569697], "outsideGeneral": [162507, 171223], "outsideSC": [536191, 536191]}
    },
    "jemtec (jims)": {
        ...
        "CSE- AIML": {"delhiGeneral": [215120, 598015], "outsideGeneral": [149813, 170471], "outsideSC": [369237, 369237]}
    },
    "fimt": {
    ...
    "echelon": {
        ...
        "B.Tech. (Mechatronics)": {"delhiGeneral": [300415, 762962], "outsideGeneral": [198498, 204568]},
        "B.Tech. (Robotics & Artificial Intelligence)": {"delhiGeneral": [366701, 747853], "outsideGeneral": [194452, 199251], "outsideSC": [716572, 716572]},
        "B.Tech. CSE (IOT) & CS including Blockchain Technology": {"delhiGeneral": [321725, 767160], "outsideGeneral": [200154, 201201]},
        ...
        "CSE- AIML": {"delhiGeneral": [245621, 692925], "outsideGeneral": [101427, 193573], "outsideSC": [608498, 608498]},
        "CSE- DS": {"delhiGeneral": [621561, 735010], "outsideGeneral": [159143, 196824], "outsideSC": [651045, 651045]},
    ...
    "sbit": {
        ...
        "CSE- AIML": {"delhiGeneral": [415931, 662375], "outsideGeneral": [176138, 190205], "outsideSC": [647307, 647307]},
    ...
    "usct": {
        "B. Tech./M. Tech. (Dual Degree in Chemical Engineering)": {"delhiGeneral": [298645, 533584], "outsideGeneral": [64503, 130328], "delhiSC": [582127, 1298183], "outsideSC": [322272, 355467]},
        "B.Tech (Energy Engineering)": {"delhiGeneral": [182287, 282396], "outsideGeneral": [99740, 131858], "delhiSC": [700515, 1327375], "outsideSC": [333500, 333500]}
    },
    "usbas": {
        "B.Tech (Industrial Chemistry)": {"delhiGeneral": [204186, 375194], "outsideGeneral": [136862, 151111], "delhiSC": [1206945, 1419362], "outsideSC": [361611, 361611]}
    },
    "bvcoe": {
        "B.Tech (Computer Science & Business Systems)": {"delhiGeneral": [166777, 190414], "outsideGeneral": [75843, 87461], "delhiSC": [796529, 1000877], "outsideSC": [368109, 368109]},
        "B.Tech CSE (AI & DS)": {"delhiGeneral": [136111, 180441], "outsideGeneral": [71073, 83220], "delhiSC": [643142, 826147], "outsideSC": [356913, 356913]},
        "Computer Science & Engineering": {"delhiGeneral": [96550, 163199], "outsideGeneral": [67801, 78157], "delhiSC": [553215, 758924], "outsideSC": [260563, 283186]},
        "CSE- AIML": {"delhiGeneral": [101441, 180106], "outsideGeneral": [71646, 82157], "delhiSC": [311416, 821343], "outsideSC": [301373, 320008]},
        "Electrical & Electronics Engineering": {"delhiGeneral": [149567, 260763], "outsideGeneral": [95149, 106760], "delhiSC": [1107870, 1107870], "outsideSC": [392276, 392276]},
        "Electronics & Communication Engineering": {"delhiGeneral": [171963, 237461], "outsideGeneral": [78123, 94237], "delhiSC": [900107, 1427731], "outsideSC": [384986, 401873]},
        "Information Technology": {"delhiGeneral": [152785, 200492], "outsideGeneral": [78959, 88109], "delhiSC": [832985, 1008086], "outsideSC": [338607, 376627]}
    }
}
...
def replace_ranks(content, college_id, branch_name, quota, min_rank, max_rank):
    college_pattern = r'(id:\s*"{0}".*?branches:\s*\[)(.*?)(?=^\s*\}}\s*,|\s*\]\s*,\s*\}}\s*;)'
    
    def repl_college(m):
        prefix = m.group(1)
        branches_str = m.group(2)
        
        parts = re.split(r'(\{\s*branch:\s*".*?")', branches_str)
        new_parts = [parts[0]]
        for i in range(1, len(parts), 2):
            branch_head = parts[i]
            branch_body = parts[i+1]
            
            # Simple substring match works unless branch name is substring of another, but these names are unique.
            # However, `replace_ranks` branch name has escape characters removed, let's normalize both to check
            if branch_name.lower().replace(" ", "") in branch_head.lower().replace(" ", ""):
                quota_pattern = r'({0}:\s*\{{\s*minRank:\s*)\d+(,\s*maxRank:\s*)\d+(\s*\}})'.format(quota)
                branch_body = re.sub(quota_pattern, r'\g<1>{0}\g<2>{1}\g<3>'.format(min_rank, max_rank), branch_body)
            new_parts.append(branch_head)
            new_parts.append(branch_body)
            
        return prefix + "".join(new_parts)

    new_content = re.sub(college_pattern.format(college_id), repl_college, content, flags=re.DOTALL | re.MULTILINE | re.IGNORECASE)
    return new_content

for col_id, branches in updates.items():
    for branch_name, quotas in branches.items():
        for quota, (min_val, max_val) in quotas.items():
            content = replace_ranks(content, col_id, branch_name, quota, min_val, max_val)

with open(FILE_PATH, 'w', encoding='utf-8') as f:
    f.write(content)

print("Remaining updates successfully written!")
